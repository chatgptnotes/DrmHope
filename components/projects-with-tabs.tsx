        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center gap-3 sm:gap-4 mb-8">
            <Button
              ...
              className={
                activeTab === "web"
                  ? "bg-red-600 hover:bg-red-700 text-white px-4 sm:px-8 py-4 sm:py-6 text-sm sm:text-lg"
                  : "border-red-300 dark:border-red-700 text-gray-700 dark:text-gray-300 hover:bg-red-50 dark:hover:bg-red-950 px-4 sm:px-8 py-4 sm:py-6 text-sm sm:text-lg"
              }
            >
