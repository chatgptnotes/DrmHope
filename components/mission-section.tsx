      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Driving Innovation Through AI Software Development
          </h2>
          <div className="flex justify-center mb-8">
            <Image
              ...
              width={128}
              height={128}
              className="w-24 h-24 sm:w-32 sm:h-32 rounded-full border-4 border-red-600 shadow-lg"
              loading="lazy"
            />
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <Card className="border-2 hover:border-red-600 transition-all duration-300 hover:shadow-xl">
            <CardHeader>
              ...
              <CardTitle className="text-2xl">Our AI Development Mission</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription className="text-base leading-relaxed text-gray-700 dark:text-gray-300">
                Our mission is to simplify AI software development, making machine learning and intelligent automation accessible to businesses through tailored solutions that optimize processes and reduce costs.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:border-red-600 transition-all duration-300 hover:shadow-xl">
            <CardHeader>
              ...
              <CardTitle className="text-2xl">Vision for Enterprise AI</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription className="text-base leading-relaxed text-gray-700 dark:text-gray-300">
                To be the premier AI software development partner empowering businesses globally through healthcare AI, AI agentic platforms, and enterprise automation that drive sustainable growth.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:border-red-600 transition-all duration-300 hover:shadow-xl">
            <CardHeader>
              ...
              <CardTitle className="text-2xl">AI Consulting Strategy</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription className="text-base leading-relaxed text-gray-700 dark:text-gray-300">
                DrM Hope conducts detailed AI consulting and discovery, analyzing goals, technology, and systems to identify high-impact opportunities in NLP, generative AI, and custom AI development with clear ROI.
              </CardDescription>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="mt-16 p-5 sm:p-8 bg-gradient-to-r from-red-600 to-purple-600 rounded-2xl text-center">
