      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-8">
            <div className="flex gap-4">
              <div className="flex-shrink-0 mt-1">
                <Code className="h-6 w-6 text-red-600 dark:text-white" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-red-700 dark:text-white">Modern Tech Stack</h3>
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0 mt-1">
                <Shield className="h-6 w-6 text-red-600 dark:text-white" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-red-700 dark:text-white">Security-First Development</h3>
                <p className="mt-2 text-gray-700 dark:text-gray-300">
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0 mt-1">
                <GitBranch className="h-6 w-6 text-red-600 dark:text-white" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-red-700 dark:text-white">Agile Methodology</h3>
                <p className="mt-2 text-gray-700 dark:text-gray-300">
          ...
          <div className="space-y-8">
            <div className="flex gap-4">
              <div className="flex-shrink-0 mt-1">
                <Database className="h-6 w-6 text-red-600 dark:text-white" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-red-700 dark:text-white">Types of Software We Develop</h3>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md border border-red-100 dark:border-red-900">
            ...
            <h3 className="text-xl font-bold text-center text-red-700 dark:text-white mb-2">Quality Assurance</h3>
            <p className="text-center text-gray-700 dark:text-gray-300">
        ...
        <div className="mt-16 bg-white dark:bg-gray-900 rounded-xl shadow-lg overflow-hidden border border-red-100 dark:border-red-900">
          <div className="p-8">
            <h3 className="text-2xl font-bold text-red-700 dark:text-white mb-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              <div className="text-center">
                <div className="bg-red-100 dark:bg-red-900 h-16 w-16 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-xl font-bold text-red-700 dark:text-white">1</span>
                </div>
                <h4 className="font-semibold text-red-700 dark:text-white">Discovery</h4>
                <p className="text-sm text-gray-700 dark:text-gray-300 mt-2">Requirements gathering and analysis</p>
              </div>

              <div className="text-center">
                <div className="bg-red-100 dark:bg-red-900 h-16 w-16 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-xl font-bold text-red-700 dark:text-white">2</span>
                </div>
                <h4 className="font-semibold text-red-700 dark:text-white">Design</h4>
                <p className="text-sm text-gray-700 dark:text-gray-300 mt-2">UX/UI and architecture planning</p>
              </div>

              <div className="text-center">
                <div className="bg-red-100 dark:bg-red-900 h-16 w-16 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-xl font-bold text-red-700 dark:text-white">3</span>
                </div>
                <h4 className="font-semibold text-red-700 dark:text-white">Development</h4>
                <p className="text-sm text-gray-700 dark:text-gray-300 mt-2">Agile sprints with CI/CD</p>
              </div>

              <div className="text-center">
                <div className="bg-red-100 dark:bg-red-900 h-16 w-16 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-xl font-bold text-red-700 dark:text-white">4</span>
                </div>
                <h4 className="font-semibold text-red-700 dark:text-white">Testing</h4>
                <p className="text-sm text-gray-700 dark:text-gray-300 mt-2">QA, security, and performance</p>
              </div>

              <div className="text-center">
                <div className="bg-red-100 dark:bg-red-900 h-16 w-16 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-xl font-bold text-red-700 dark:text-white">5</span>
                </div>
                <h4 className="font-semibold text-red-700 dark:text-white">Deployment</h4>
